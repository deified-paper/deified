...
struct InstrumentVisitor : public InstVisitor<InstrumentVisitor> {
    ...
    void visitModule(Module &M) {
        ...
        createHQFunctions(IRB, M, nullptr, nullptr, nullptr, &PCF, nullptr,
                          &PDF, &PIF, &SCF, &PMCF, nullptr, &PRF);
    }
    ...
    void visitStoreInst(StoreInst &SI) {
        ...
        if (isFunctionPointer(*Val, UseStrictFP)) {
            ...
            if (!isa<ConstantPointerNull>(Val)) {
                ...
                // stack-allocated
                if (auto *AI = dyn_cast<AllocaInst>(simplify(Dst, RECURSE_GEP)))
    ...
    void visitCallBase(CallBase &CB) {
        ...
        if (Name && isConstructor(*Name)) {
            ...
            if (auto *AI = dyn_cast<AllocaInst>(
                    simplify(CB.getArgOperand(0), RECURSE_GEP)))
    ...
    void visitIntrinsicInst(IntrinsicInst &II) {
        ...
        case Intrinsic::lifetime_end:
            ...
            if (auto *AI = dyn_cast<AllocaInst>(const_cast<Value *>(
                    simplify(II.getArgOperand(1), RECURSE_GEP)))) {
